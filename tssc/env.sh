...
export IMAGE_URL=${IMAGE_URL-quay.io/tsscui/backend-tests-go-zpqdcfmo:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-org/backend-tests-go-zpqdcfmo-gitops
